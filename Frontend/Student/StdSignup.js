...
import { View, TextInput, Button, StyleSheet, Alert, ImageBackground,ScrollView, TouchableOpacity, Text ,Image} from 'react-native';
      ...
      >
        ...
        <View style={{marginTop:-15,marginLeft:20}}>
          <Text>Already have a account Plaese?
            <Text style={{color:"blue",fontSize:15}} onPress={()=>navigation.navigate('stdlogin')}  >Login</Text>
          </Text>
        </View>
        </ScrollView>
      </ImageBackground>
